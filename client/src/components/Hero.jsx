...
const Hero = () => {
    ...
    const onSearch = async (e) => {
        ...
        // call api to set recent searched cities
  ...
  return (
    <div className='flex flex-col  px-6 md:px-16 lg:px-24 xl:px-32 items-start justify-center h-screen bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-center bg-cover text-white'>
