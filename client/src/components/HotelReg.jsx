...
const HotelReg = () => {
  ...
  return (
    <div onClick={()=>{setShowHotelReg(false)}} className='fixed top-0 bottom-0 left-0 right-0 z-100 bg-black/70 flex items-center justify-center'>
      <form onSubmit={onSubmitHandler} onClick={(e)=>e.stopPropagation()} className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4'>
                ...
                <input id='contact' onChange={(e)=>setScontact(e.target.value)} value={contact} type="text" placeholder='Type here' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
            </div>
            {/* Address */}
            <div className='w-full mt-4'>
