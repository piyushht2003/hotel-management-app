...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title='My Bookings' subTitle='Easily manage your past, current, and upcoming hotel reservation in one place. Plan your trips seemlessly with just a few clicks' align={screenLeft} />
          ...
          <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full py-6 border-b border-gray-300 first:border-t'>
            ...
            <div className='flex flex-col md:flex-row'>
              ...
              <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                  ...
                  <span className='font-inter text-sm'> ({booking.hotel.roomType})</span>
                  </p>
